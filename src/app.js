		...
		<div id="modeContainer" className={isDark && "dark"}>
			<div className="scrollContainer">
				...
				<div id="PokeGrid" className="mx-auto container row">{pokes && pokes.map((poke,i) => (
						(poke.name.includes(searchParams) || (i+1).toString().startsWith(searchParams)) && <LazyLoad className="cardlazy col-12 col-sm-6 col-lg-4" scrollContainer=".scrollContainer" offset={150} height={98} once >
							<PokeCard
								key={i}
								number={i+1}
								index={i}
